...
public sealed class LocalizationService
{
    private static readonly Dictionary<string, string> ExtendedEnglish = new()
    {
        ...
        ["AboutDescription"] = "Native Windows download manager for videos and Instagram — one app, no Python or Node setup. Powered by yt-dlp and FFmpeg.",
    ...
    private static readonly Dictionary<string, string> ExtendedArabic = new()
    {
        ...
        ["AboutDescription"] = "مدير تنزيل فيديو وإنستغرام لنظام Windows — تطبيق واحد بدون Python أو Node. يعمل عبر yt-dlp و FFmpeg.",
